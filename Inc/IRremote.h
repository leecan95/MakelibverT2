...
// setting the timer for reception - overflow every 50 μs (in this case, the system frequency is 84 MHz)
#define MYPRESCALER 83 // we get a frequency of 1 MHz
#define MYPERIOD 49    // 50 μs

// setting the timer for sending - specify the system frequency of the timer
#define MYSYSCLOCK 83000000

// setting the pin for receiving recive_IR
...
#define decodetim htim2
#define instance_tim TIM2
...
//////////////////////////////////// activated protocols ////////////////////////////////////////
#define DECODE_RC5           1 // to disable decoding of the RC5 protocol, specify 0
#define SEND_RC5             1 // to disable signal sending via RC5 protocol, specify 0
